                    ...
                    <div className="grid md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <a href="/" class="flex items-center">
                                ...
                                <span class="self-center text-3xl font-semibold whitespace-nowrap dark:text-white ms-6">Remind<span className='text-[#2D76F9]'>me</span></span>
                            </a>

                            <p className="text-[#747474] md:text-md sm:pe-80 md:pe-24 pt-4 md:pt-10 leading-[170%]">Task deadlines and scheduling applications with various benefits and advantages</p>
                        ...
                        <div className='mt-5 md:mt-3'>
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <ul className="pt-4 md:pt-10">
                                        <li className="cursor-pointer text-[#747474] text-sm sm:text-md hover:text-[#2D76F9] font-semibold transition-all ease-in delay-150">
                                            <a href="/"><span className="text-[#2D76F9] text-xl">• </span> Home</a>
                                        </li>

                                        <li className="cursor-pointer text-[#747474] text-sm sm:text-md hover:text-[#2D76F9] font-semibold transition-all ease-in delay-150">
                                            <a href="#features"><span className="text-[#2D76F9] text-xl">• </span> Feature</a>
                                        </li>

                                        <li className="cursor-pointer text-[#747474] text-sm sm:text-md hover:text-[#2D76F9] font-semibold transition-all ease-in delay-150">
                                            <a href="#download"><span className="text-[#2D76F9] text-xl">• </span> About</a>
                                        </li>
                                ...
                                <div>
                                    ...
                                    <ul className="pt-4 md:pt-10">
                                        <li className="cursor-pointer text-[#747474] text-sm sm:text-md hover:text-[#2D76F9] font-semibold transition-all ease-in delay-150">
                                            <a href=""><span className="text-[#2D76F9] text-xl">• </span> Set Task Better</a>
                                        </li>

                                        <li className="cursor-pointer text-[#747474] text-sm sm:text-md hover:text-[#2D76F9] font-semibold transition-all ease-in delay-150">
                                            <a href=""><span className="text-[#2D76F9] text-xl">• </span> Easy Manage</a>
                                        </li>

                                        <li className="cursor-pointer text-[#747474] text-sm sm:text-md hover:text-[#2D76F9] font-semibold transition-all ease-in delay-150">
                                            <a href=""><span className="text-[#2D76F9] text-xl">• </span> Get Notification</a>
                                        </li>
