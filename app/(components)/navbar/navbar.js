        ...
        <header>
          <div className="xl:mx-auto xl:max-w-[1440px] px-[1.5rem] md:px-[3rem] lg:px-[6rem] flex py-5 justify-between text-[16px] font-semibold select-none transition-all ease-linear duration-650">
            <Link href="/" class="flex items-center lg:hidden">
              <div className="p-1 bg-green rounded-md rotate-45">
                <svg
              ...
              <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white ms-4">
                Remind<span className="text-[#2D76F9]">me</span>
              </span>
            </Link>

            <span
              className={`cursor-pointer lg:hidden block transition-all ease-in duration-500 text-2xl border border-[#2D76F9] p-1 rounded-lg text-[#2D76F9] hover:text-white hover:bg-[#2D76F9] `}
            ...
            <ul
              className={`block absolute px-[1.5rem] md:px-[3rem] lg:flex align-right lg:items-center !z-[100] transition-all ease-in duration-500 w-[100%] left-0 top-0 lg:w-auto lg:z-auto lg:static  lg:bg-none  lg:space-x-20 space-y-2.5 lg:space-y-0 my-auto opacity-100 p-3 lg:p-0   
                            ${
                              open
                                ? " top-[63px] opacity-100 h-[100vh] lg:h-0 lg:bg-transparent bg-white space-y-10"
                                : " top-[-300px] opacity-0"
                            }`}
            >
